...
import { getPullReqDiff, postReviewComment } from "@/module/github/github";
...
export const generateReview = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    console.log("📚 Pinecone chunks:", context.length);
...
Format your response in markdown.`;
    ...
    console.log("✍️ AI review generated, length:", review.length);
